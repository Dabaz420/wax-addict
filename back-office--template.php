    ...
    <div class="toutproduits">
      ...
      for ($i=0; $i<$arrayLength; $i++) {
        echo("<div class='produit'>");
          ...
          echo("<p class='altnom'>Noms alternatifs : ".$arrayContentJsonProductsProperties['nom alternatif']."</p>");
          echo("<a class='bouton' href='#popup". $i ."'><img class='imgWax' src='".$arrayContentJsonProductsProperties['image']."'></a>");
          echo("<div id='popup" . $i ."' class='overlay'>");
            echo("<img class='imgPop' src='".$arrayContentJsonProductsProperties['image']."'>");
